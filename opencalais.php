...
$contact_details = array();
        foreach ($object as $item) {
            if (isset($item->_type) && strtolower($item->_type) == "emailaddress") {
                $contact_details[]=$item;
            }
            if (isset($item->_type) && strtolower($item->_type) == "phonenumber") {
                 $contact_details[]=$item;
            }
            if (isset($item->_type) && strtolower($item->_type) == "company") {
                 $contact_details[]=$item;
            }
            if (isset($item->_type) && strtolower($item->_type) == "contactdetails") {
                 $contact_details[]=$item;
            }
        ...
        return $contact_details;//$this->entities;
    }
